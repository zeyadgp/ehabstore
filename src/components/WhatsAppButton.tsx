...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 start-4 md:bottom-6 md:start-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lift transition-transform hover:scale-110"
    >
